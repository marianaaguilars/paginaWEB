...
<body>
	...
	<div class="container">
		 ...
		 <div class="row">
		 	<div class="col-sm-12">
		 		<span class="btn btn-default" id="ventaProductosBtn" style="background-color:salmon;">Vender Producto</span>
		 		<span class="btn btn-default" id="ventasHechasBtn" style="background-color:salmon;">Ventas Hechas</span>
		 	</div>
		 </div>
		 <div class="row">
		 	<div class="col-sm-12">
